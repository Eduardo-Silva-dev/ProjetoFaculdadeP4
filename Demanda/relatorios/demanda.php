<?php require '../repository/conDemandas.php';
...
<head>
  ...
  <title> Relatorio de Demandas</title>
...
<body class="bg-white">
  ...
  <div class="row">
    ...
    <div class="col-12 col-sm-9" style="text-align:center; justify-content:center; align-items:center; margin-top:20px;">
      <div class="container">
        <div class="card card-header">Relatorios de Demandas</div>
