...
<link rel="stylesheet" type="text/css" href="styles\index1.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="styles\modalAviso.css" media="screen" />
           ...
           <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalCenterTitle">      Seja Bem-Vindo,   <?php //echo"$logado ";?></h5>
                </div>
